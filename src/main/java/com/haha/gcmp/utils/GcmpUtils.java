...
import static com.haha.gcmp.config.GcmpConst.FILE_SEPARATOR;
...
public class GcmpUtils {
    ...
    public static String normalizeUrl(@NonNull String originalUrl) {
        ...
        if (StringUtils.startsWithAny(originalUrl, URL_SEPARATOR, GcmpConst.PROTOCOL_HTTPS, GcmpConst.PROTOCOL_HTTP)
